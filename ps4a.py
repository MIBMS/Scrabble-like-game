...
WORDLIST_FILENAME = "C:\Users\Ilham\SkyDrive\Documents\Programming\Python stuff\ProblemSet4\words.txt"
...
def getWordScore(word, n):
    ...
    sumWvalues = 0
    for i in word:
        sumWvalues += SCRABBLE_LETTER_VALUES[i]
    sumWlenscore = sumWvalues * len(word)
    if len(word) == n:
        return sumWlenscore + 50
    else:
        return sumWlenscore
